    const dictionaries = {}
        ...
        // Function to show the specific overlay (How to Play or Settings)
function showOverlay(type) {
    // Hide everything first to prevent overlap
    closeAll();
    
    const overlayId = type === 'howtoplay' ? 'howtoplay-overlay' : 'settings-overlay';
...
function showModal(type) {
    ...
    if (type === 'stats') {
        ...
        // Add your logic here to populate stats-content if needed
    }
}

// Universal Close Function (Closes everything)
function closeAll() {
    // Remove 'show' class from all potential modals/overlays
...
// Ensure the backdrop and close buttons work
